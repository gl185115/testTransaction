 ...
 *
 * <P>
 * A SportStoreMemberInfo Node in POSLog XML.
 *
 *
 */
@XmlAccessorType(XmlAccessType.NONE)
@XmlRootElement(name = "MemberInfo")
public class SportStoreMemberInfo {
    /**
    ...
    public String toString() {
        return "SportStoreMemberInfo [unifiedMembershipId=" + unifiedMembershipId + ", quantityForPoints=" + quantityForPoints
