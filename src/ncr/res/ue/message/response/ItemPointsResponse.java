...
/**
 * class that holds the response for Item Points Message.
 *
 */
public class ItemPointsResponse extends UEResponseBase {
     ...
     */
    public ItemPointsResponse(final int msgType,
