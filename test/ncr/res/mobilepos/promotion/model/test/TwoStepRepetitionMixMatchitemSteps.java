...
import ncr.res.mobilepos.promotion.model.SecondStepRepetitionMixMatchItem;
...
/**
 * The Class TwoStepRepetitionMixMatchitemSteps.
 */
public class TwoStepRepetitionMixMatchitemSteps extends Steps {

    /** The first step rep. */
    SecondStepRepetitionMixMatchItem twoStepRep = null;
    ...
    public final void givenMMData(ExamplesTable exampleTables) {
        for (Map<String, String> mmDataTemp : exampleTables.getRows()) {
            ...
            mmData.setType(2);
            twoStepRep = new SecondStepRepetitionMixMatchItem(
                    mmData.getCode());
            twoStepRep.setMixMatchData(mmData);
        }
    }
     ...
     *            the example tables
     */
    @Given("a discount rate MixMatchData of the following: $exampleTables")
    public final void givenDiscountMMData(ExamplesTable exampleTables) {
        for (Map<String, String> mmDataTemp : exampleTables.getRows()) {
            String MMCode = mmDataTemp.get("MMCode");
            int MMQ = Integer.parseInt(mmDataTemp.get("MMQ"));
            int MMP = Integer.parseInt(mmDataTemp.get("MMP"));
    ...
    public final void computeFirstStepRep() {
        discounts = twoStepRep.computeDiscount();
    }
