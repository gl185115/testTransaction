...
public class ClassInfoResource {
    ...
    public final SearchedClassInfo list(
        ...
        try {
            ...
            classInfoList = classInfoDAO.listClasses(retailstoreid, departmentid, key, name, limit, companyid);
    ...
    public final ResultBase createClassInfo(
        ...
        try {
            ...
            ViewLine viewLine = lineRes.selectLineDetail(
                    classInfo.getRetailStoreId(), classInfo.getDepartment(), classInfo.getLine(), classInfo.getCompanyId());
    ...
    public final ViewClassInfo updateClassInfo(
        ...
        try {
			...
			ViewClassInfo viewClasInfoTemp = this.selectClassInfoDetail(retailStoreId, departmentid, lineid, classid, companyid);
            ...
            if(!retailStoreId.equals(classInfo.getRetailStoreId()) || !classid.equals(classInfo.getItemClass()) || !lineid.equals(classInfo.getLine()) || !departmentid.equals(classInfo.getDepartment())){
            	...
            	viewClasInfoTemp = this.selectClassInfoDetail(classInfo.getRetailStoreId(), classInfo.getDepartment(), classInfo.getLine(), classInfo.getItemClass(), classInfo.getCompanyId());
    ...
    public final ViewClassInfo selectClassInfoDetail(
		...
		try {
            ...
            classInfoModel = iClassInfoDAO.selectClassInfoDetail(retailStoreID, departmentid, lineid, classid, companyID);
        } catch (DaoException daoEx) {
            LOGGER.logAlert(
                    PROG_NAME,
                    functionName,
