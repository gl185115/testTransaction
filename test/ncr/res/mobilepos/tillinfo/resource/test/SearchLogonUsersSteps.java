...
public class SearchLogonUsersSteps extends Steps {
    ...
    @When("I perform a getExecuteAuthotity request with "
    ...
    @When("I perform a releaseExecuteAuthotity request with "
    		+ "retailstoreid:$retailStoreId, "
    		+ "tillid:$tillId, "
    		+ "terminalid:$terminalId, "
    		+ "operatorno:$operatorNo, "
