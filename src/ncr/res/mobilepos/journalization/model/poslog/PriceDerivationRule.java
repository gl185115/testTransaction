...
public class PriceDerivationRule {
    ...
    /**
     * @param priceDerivationRuleIDToSet
     *            the priceDerivationRuleID to set
     */
    public final void setPriceDerivationRuleID(final String priceDerivationRuleIDToSet) {
     ...
     */
    public final void setEligibility(final Eligibility eligibility) {
