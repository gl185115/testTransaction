...
@Api(value="/customeraccount", description="å⁄ãqÉAÉJÉEÉìÉgä÷òAAPI")
public class CustomerAccountResource {
    ...
    @ApiOperation(value="å⁄ãqèÓïÒÇìæÇÈ", response=Customer.class)
    @ApiResponses(value={})
    public final Customer getCustomerByID(@ApiParam(name="customerid", value="å⁄ãqî‘çÜ") @PathParam("customerid")
                          final String customerid,
                          @ApiParam(name="deviceno", value="ê›îıî‘çÜ") @FormParam("deviceno") final String deviceNo,
                          @ApiParam(name="operatorno", value="è]ã∆àıî‘çÜ") @FormParam("operatorno") final String operatorNo) {
