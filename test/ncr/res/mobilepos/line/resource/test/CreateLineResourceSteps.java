 ...
 * @author sr185217
 */
public class CreateLineResourceSteps extends Steps {
    /**
     ...
     */
    @When("the following line is added: $newline")
    public final void theFollowingLineIsAdded(final ExamplesTable newline) {
        Map<String, String> lineinfo = newline.getRow(0);        
        String linejson = lineinfo.get("linejson");        
        if (linejson.equals("null")) {
            linejson = null;
        }
        actualresultBase =
            lineResource.createLine(linejson);
    }    
    /**
