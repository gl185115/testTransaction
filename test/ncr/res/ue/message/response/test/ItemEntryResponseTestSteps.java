...
public class ItemEntryResponseTestSteps extends Steps{
    private ItemEntryResponse resp = null;
    private String message = "";
    private String [] multiple = {"002200000031000000009300",
                                        "002200000031000000000300"};
    
    @When("I create item entry response with $messageType and ($message) expect ($expected)")
    public void createItemEntryResponse(int messageType, String message, String expected) throws MessageException{
        try {
            resp = new ItemEntryResponse(messageType, message);
