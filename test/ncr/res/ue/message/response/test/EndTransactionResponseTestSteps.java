...
public class EndTransactionResponseTestSteps extends Steps{
    private EndTransactionResponse resp = null;
    private String message = "";
    private String [] multiple = {"002200000031000000009300",
                                        "002200000031000000000300"};
    
    @When("I create end transaction response with $messageType and ($message) expect ($expected)")
    public void createEndTransactionResponse(int messageType, String message, String expected) throws MessageException{
        try {
            resp = new EndTransactionResponse(messageType, message);
