...
public class CancelOperationResponseSteps extends Steps {
    private CancelOperationResponse resp = null;

    @When("I create cancel operation with $messageType and ($message) expect ($expected)")
    public void createItemQuantityResponse(int messageType, String message, String expected) throws MessageException{
        try {
            resp = new CancelOperationResponse(messageType, message);
