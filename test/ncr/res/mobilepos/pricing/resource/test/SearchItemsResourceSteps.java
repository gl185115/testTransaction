...
public class SearchItemsResourceSteps extends Steps {
    ...
    public final void setUpClass() throws Exception {
        Requirements.SetUp();
        dbInitiator = new DBInitiator("SearchItemResourceSteps", DATABASE.RESMaster);
    }
    ...
    @When("I get the list of Items with storeid {$storeId}, key {$key} and name {$name}")
    public final void getListItems(final String storeId, final String key, 
        ...
        actualSearchedProducts = itemResource.search(storeId, keyTemp, nameTemp, 0);
    }
            ...
            try {
	            for (Map<String, String> expItem : expItemRows) {
	                ...
	                Assert.assertEquals("Compare the Sales Regular Price: ",
	                        BigDecimal.valueOf(Integer.parseInt(expItem
	                                .get("regularprice"))), actualDataRows
