 ...
 * @author sr185217
 */
public class UpdateClassInfoResourceSteps extends Steps {
    /**
    ...
    /**
     * When Step: Update a classinfo.
     * @param newClassInfo The new classinfo.
     */
    @When("the following classinfo is updated: $newClassInfo")
    public final void theFollowingLineIsUpdated(final ExamplesTable newClassInfo) {
        Map<String, String> classinfo = newClassInfo.getRow(0);  

        String classInfojson = classinfo.get("classjson");     
        classInfojson = (null == classInfojson || "null".equalsIgnoreCase(classInfojson))? null : classInfojson;        
       
        String retailstoreid = classinfo.get("retailstoreid"); 
        retailstoreid = (null == retailstoreid || "null".equalsIgnoreCase(retailstoreid))? null : retailstoreid; 
        
        String department = classinfo.get("department");     
        department = (null == department || "null".equalsIgnoreCase(department))? null : department; 
                
        String lineid = classinfo.get("lineid");     
        lineid = (null == lineid || "null".equalsIgnoreCase(lineid))? null : lineid;
        
        String itemClass = classinfo.get("classid");     
        itemClass = (null == itemClass || "null".equalsIgnoreCase(itemClass))? null : itemClass;
                
        actualresultBase =
            classInfoResource.updateClassInfo(retailstoreid, department, lineid, itemClass, classInfojson);
   }    
