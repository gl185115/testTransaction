...
public class SQLServerMujiPassportDAO extends AbstractDao implements IMujiPassportDAO {

    private final String PROG_NAME = "MujiPassportDao";
     ...
     * @throws DaoException
     */
    public SQLServerMujiPassportDAO() throws DaoException {
    ...
    public Map<String, String> getPrmSystemConfigValue(String Category) throws DaoException {
        ...
        try {
            ...
            throw new DaoException("SQLException:" + " @SQLServerMujiPassportDAO.getPrmSystemConfigValue", sqlEx);
        } catch (Exception ex) {
            LOGGER.logAlert(PROG_NAME, Logger.RES_EXCEP_GENERAL, functionName + ": Failed to get guestzone list.", ex);
            throw new DaoException("Exception:" + " @SQLServerMujiPassportDAO.getPrmSystemConfigValue", ex);
        } finally {
