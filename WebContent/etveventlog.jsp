<%@ page language="java" pageEncoding="utf-8"%><%@page import="ncr.res.mobilepos.eventlog.resource.EventLogResource"%><%
if (request.getParameter("c") != null) {
   out.print(new EventLogResource().read(request.getParameter("c"),
