...
<label class="res-info-msg"><%out.println(infoString); %></label>
	<div class="table-scroll-area-v table-scroll-area-h" id="table" style="height: 200px;">
		<table class="res-tbl">
			<thead>
				<tr>
					<th></th>
...
<form action="DeviceAttributeUpdate.jsp" method="post" id="updateform">
  <input type="hidden" name="AttributeId" id="AttributeId">
<div id="updateArea" style="display:none">
	<div class="panel">
		<table border="0" cellspacing="4" cellpadding="4" id="tablearea" style="display:none;">
			<tr>
			<tr>
			...
			<tr>
				...
				<td align="left"><input type="text" id="ATTDescription" name="ATTDescription" size=50 maxlength="25" required pattern=".{0,25}">(全角25文字以内で入力してください)</td>
			</tr>
			<tr>
