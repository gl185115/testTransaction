...
public class ItemPointsResponseTestSteps extends Steps{
    private ItemPointsResponse resp = null;
    private String message = "";
    private String [] multiple = {"002200000031000000009300",
                                        "002200000031000000000300"};
    
    @When("I create adjustment response with $messageType and ($message) expect ($expected)")
    public void createItemPointsResponse(int messageType, String message, String expected) throws MessageException{
        try {
            resp = new ItemPointsResponse(messageType, message);
