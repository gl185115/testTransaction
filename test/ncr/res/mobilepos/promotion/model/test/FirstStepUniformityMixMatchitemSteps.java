 ...
 */
public class FirstStepUniformityMixMatchitemSteps extends Steps {

    /** The first step rep. */
    FirstStepUniformityMixMatchItem firstStepUniformity = null;
    ...
    public final void givenMMData(ExamplesTable exampleTables) {
        for (Map<String, String> mmDataTemp : exampleTables.getRows()) {
            ...
            mmData.setType(MixMatchItem.FIRST_STEP_UNIFORMITY_PRICE);
            firstStepUniformity = new FirstStepUniformityMixMatchItem(
                    mmData.getCode());
            firstStepUniformity.setMixMatchData(mmData);
        }
    }
    ...
    public final void addSale(ExamplesTable exampleTables) {
        for (Map<String, String> data : exampleTables.getRows()) {
            ...
            firstStepUniformity.addItem(sale);
        }
    }
    ...
    public final void computeFirstStepRep() {
        discounts = firstStepUniformity.computeDiscount();
    }
